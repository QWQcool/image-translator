...
3. **画布变换手柄与就地编辑**：
   ...
   ![文字层画布变换手柄与旋转手柄（截图待补，位置：选中文字层后的画布状态）](screenshots/待补-文字层变换手柄.png)
4. **去字修图（三级引擎 + 多种蒙版来源）**：
   ...
   ![选区去字与液化（截图待补，位置：套索选区后的虚线框与液化拖动效果）](screenshots/待补-选区去字与液化.png)
5. **背景调整（非破坏色阶）**：
   ...
   ![背景调整面板（截图待补，位置：右侧栏背景调整折叠面板展开状态）](screenshots/待补-背景调整面板.png)
6. **直出成品**：
